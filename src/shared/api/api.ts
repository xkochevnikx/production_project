...
export const $api = axios.create({
    //! используем глобальную переменную котора доступна благодаря плагину. Если при сборке мы не задали переменную окружения env то берётся дефолтное значение и передаётся в плагин
    baseURL: __API__,
