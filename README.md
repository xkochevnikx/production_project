...
- Под каждой статьей пользователь может оставлять комментарии.
  ...........
...
<br/> 
2. eslint-plugin-fsd-path-svt - запрещает использовать абсолютные импорты в рамках одного модуля, они должны быть относительными.<br/>
