...
export function buildCssLoaders(isDev: boolean) {
    return {
        ...
        use: [
            ...
            //! если у нас сборка дев то пихаем стили в джс файл если продакш то делаем отдельных файл со стилями, это делаем плагин. а его настройка делается в билдплагинс
            isDev ? 'style-loader' : MiniCssExtractPlugin.loader,
            {
                loader: 'css-loader',
                options: {
                    //! добавление этой опции уже позволяет работать с модулями
                    modules: {
